...
function lb_ban(){
	...
	$('.b_hot_ul_d>ul>li').eq(sum_ban).addClass('b_hot_li_checked').siblings().removeClass('b_hot_li_checked');
};
/*---------------banner列表点击效果--------------*/
...
//});
$('.b_hot_ul_d').on('mouseenter','li ul li',function(){
	$(this).find('p.clearfix').stop(true,true).fadeIn();
});
$('.b_hot_ul_d').on('mouseleave','li ul li',function(){
		$(this).find('p.clearfix').fadeOut();
});	
$('.l_xw_list_d').on('mouseenter','li ul li',function(){
	$(this).find('p.clearfix').stop(true,true).fadeIn();
});
$('.l_xw_list_d').on('mouseleave','li ul li',function(){
		$(this).find('p.clearfix').fadeOut();
});	
